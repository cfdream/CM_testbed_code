...
import os
import sys
from one_setting_result_calculator_method4 import one_setting_result_calculator_c
...
class results_analyzer_c():
    ...
    def new_output_one_setting_result(self, host_switch_sample, replace, memory_type, memory_times, freq, inject_or_tag_packet, one_setting_result):
        with open('result_analysis_method4_result.num', 'a') as out_file:
            #setting info
            ...
            .format(host_switch_sample=host_switch_sample, \
                ...
                avg_real_target_flow_num = 0, \
                avg_fn_num = 0, \
                avg_condition_pkt_num = 0
            )) 
        with open('result_analysis_method4_result.txt', 'a') as out_file:
            #setting info
